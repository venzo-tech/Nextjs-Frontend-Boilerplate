...
const ForgotPassword = () => {
  ...
  return (
    <div className="flex flex-col space-y-10 w-[30%] p-5">
      <button
        type="button"
        className="bg-blue-600 text-[18px] text-white w-[15%] p-1 px-4 rounded"
          ...
          <button
            ...
            className={`w-full rounded-md py-2 px-3 text-sm font-medium text-center ${
              isLoading
                ...
                : "bg-indigo-600 text-white hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            }`}
          >
